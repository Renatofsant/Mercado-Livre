...
nome_arquivo_tabela = r"C:\Extrações\Mercado_Livre\Dados_ML_Caneca termica.xlsx"
planilhaDadosTabela = load_workbook(nome_arquivo_tabela)

#Selecionar a sheet de dados
sheet_dados = planilhaDadosTabela['Canecas']
print()
...
#Preenche os campos
pausa.sleep(0.5)
nav.find_element(By.NAME, "as_word").send_keys("Caneca termica")
